#!/bin/bash
# Experiment B: re-run annotate.py on 4 vertebrates_test species with
# 20 'N' bases prepended to each transcript before inference, via
# --prefix-pad-n 20. Same epoch_11 weights as the baseline.
#
# Output:  ${RESULTS_DIR}/<sp>/annotate_${WEIGHTS_TAG}_pad20/orfs.gtf
#
#SBATCH --job-name=annot_vt_pad20
...
#SBATCH --array=0-3
#SBATCH --output=/projects/AI-GUSTUS/tiberius_orf_finder/logs/annot_vt_pad20_%A_%a.out
#SBATCH --error=/projects/AI-GUSTUS/tiberius_orf_finder/logs/annot_vt_pad20_%A_%a.err
...
OUTDIR=${RESULTS_DIR}/${species}/annotate_${WEIGHTS_TAG}_pad20
