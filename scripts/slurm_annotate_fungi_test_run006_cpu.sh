...
# run006 full-fungi model — CPU-only variant (snowball/pinky, 72 CPUs).
#
# Usage: sbatch scripts/slurm_annotate_fungi_test_run006_cpu.sh [epoch]
#   epoch defaults to the highest epoch_N checkpoint in the model dir.
#
#SBATCH --job-name=annot_fun_cpu
#SBATCH --partition=snowball,pinky
#SBATCH --cpus-per-task=72
#SBATCH --mem=128G
#SBATCH --time=24:00:00
#SBATCH --array=0-6
#SBATCH --output=/projects/AI-GUSTUS/tiberius_orf_finder/logs/annot_fun_cpu_%A_%a.out
#SBATCH --error=/projects/AI-GUSTUS/tiberius_orf_finder/logs/annot_fun_cpu_%A_%a.err
