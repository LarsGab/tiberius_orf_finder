#!/bin/bash
#SBATCH --job-name=tiberius_smoke
#SBATCH --cpus-per-task=1
#SBATCH --mem=4G
#SBATCH --time=72:00:00
#SBATCH --output=/home/gabriell/tiberius_orf_finder/logs/tiberius_smoke_%j.out
#SBATCH --error=/home/gabriell/tiberius_orf_finder/logs/tiberius_smoke_%j.err
...
/home/gabriell/programs/nextflow run nextflow/main.nf \
    ...
    --species_csv nextflow/conf/species_smoke.csv \
    ...
    --outdir /home/gabriell/tiberius_orf_finder/results/smoke \
    -resume
