#!/bin/bash
#SBATCH --job-name=pred_r006_emb
#SBATCH --partition=vision
#SBATCH --gres=gpu:1
#SBATCH --mem=32G
#SBATCH --cpus-per-task=4
#SBATCH --time=04:00:00
#SBATCH --output=/home/gabriell/tiberius_orf_finder/logs/predict_run006_embryophyta_%j.out
#SBATCH --error=/home/gabriell/tiberius_orf_finder/logs/predict_run006_embryophyta_%j.err

# Usage:  sbatch scripts/slurm_predict_cnn_lstm_run006_embryophyta.sh <epoch_N>
set -euo pipefail
