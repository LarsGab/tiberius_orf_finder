...
#SBATCH --array=0-7
#SBATCH --output=/projects/AI-GUSTUS/tiberius_orf_finder/logs/annot_r008_%A_%a.out
#SBATCH --error=/projects/AI-GUSTUS/tiberius_orf_finder/logs/annot_r008_%A_%a.err
...
WEIGHTS=${PROJDIR}/results/models/cnn_lstm_vertebrates_run008/best.weights.h5
CONFIG=${PROJDIR}/configs/cnn_lstm_vertebrates_run001.yaml
TAG=run008_best_${FILT_TAG}
