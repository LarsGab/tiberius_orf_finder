...
#SBATCH --output=/home/gabriell/tiberius_orf_finder/logs/train_run006_diatoms_%j.out
#SBATCH --error=/home/gabriell/tiberius_orf_finder/logs/train_run006_diatoms_%j.err
