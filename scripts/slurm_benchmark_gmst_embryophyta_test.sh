#!/bin/bash
# Run GeneMarkS-T on the 7 embryophyta test species.
# Mirrors slurm_benchmark_gmst_vertebrates_test.sh.
#
#SBATCH --job-name=gmst_emb
#SBATCH --partition=snowball,pinky,batch
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --time=12:00:00
#SBATCH --array=0-6
#SBATCH --output=/projects/AI-GUSTUS/tiberius_orf_finder/logs/gmst_emb_%A_%a.out
#SBATCH --error=/projects/AI-GUSTUS/tiberius_orf_finder/logs/gmst_emb_%A_%a.err
