#!/bin/bash
# Run TransDecoder v1 (TD1) on Aspergillus_fumigatus, Candida_parapsilosis,
# and Fusarium_redolens in training_fungi_v2.
# Mirrors slurm_benchmark_transdecoder1_fungi_test.sh.
#
#SBATCH --job-name=td1_tv2
#SBATCH --partition=snowball,pinky,batch
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --time=12:00:00
#SBATCH --array=0-2
#SBATCH --output=/projects/AI-GUSTUS/tiberius_orf_finder/logs/td1_tv2_%A_%a.out
#SBATCH --error=/projects/AI-GUSTUS/tiberius_orf_finder/logs/td1_tv2_%A_%a.err
