...
# run006 Aspergillus+Penicillium subset model — CPU-only variant.
#
# Usage: sbatch scripts/slurm_annotate_fungi_test_run006_asp_pen_cpu.sh [epoch]
#   epoch defaults to the highest epoch_N checkpoint in the model dir.
#
#SBATCH --job-name=annot_asp_pen_cpu
#SBATCH --partition=snowball,pinky
#SBATCH --cpus-per-task=72
#SBATCH --mem=128G
#SBATCH --time=24:00:00
#SBATCH --array=0-6
#SBATCH --output=/projects/AI-GUSTUS/tiberius_orf_finder/logs/annot_asp_pen_cpu_%A_%a.out
#SBATCH --error=/projects/AI-GUSTUS/tiberius_orf_finder/logs/annot_asp_pen_cpu_%A_%a.err

set -euo pipefail

PROJDIR=/projects/AI-GUSTUS/tiberius_orf_finder
TESTDIR=${PROJDIR}/results/fungi_test
MODEL_DIR=${PROJDIR}/results/models/cnn_lstm_run006_fungi_asp_pen
...
OUTDIR=${TESTDIR}/${species}/annotate_run006_asp_pen_e${EPOCH}
