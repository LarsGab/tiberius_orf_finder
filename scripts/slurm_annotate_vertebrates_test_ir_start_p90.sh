#!/bin/bash
# Experiment A3: re-run annotate.py on 4 vertebrates_test species with
# --restrict-start-to-ir-start and IR/START prior = 0.9 / 0.1.
#
# Output:  ${RESULTS_DIR}/<sp>/annotate_${WEIGHTS_TAG}_ir_start_p90/orfs.gtf
#
#SBATCH --job-name=annot_vt_ir_p90
...
#SBATCH --array=0-3
#SBATCH --output=/projects/AI-GUSTUS/tiberius_orf_finder/logs/annot_vt_ir_p90_%A_%a.out
#SBATCH --error=/projects/AI-GUSTUS/tiberius_orf_finder/logs/annot_vt_ir_p90_%A_%a.err
...
OUTDIR=${RESULTS_DIR}/${species}/annotate_${WEIGHTS_TAG}_ir_start_p90
