#!/bin/bash
#SBATCH --job-name=train_r006_chl
#SBATCH --partition=vision
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#SBATCH --cpus-per-task=8
#SBATCH --time=72:00:00
#SBATCH --output=/home/gabriell/tiberius_orf_finder/logs/train_run006_chlorophyta_%j.out
#SBATCH --error=/home/gabriell/tiberius_orf_finder/logs/train_run006_chlorophyta_%j.err
