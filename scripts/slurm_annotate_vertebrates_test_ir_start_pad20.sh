#!/bin/bash
# Experiment A+B: re-run annotate.py on 4 vertebrates_test species with
# BOTH --restrict-start-to-ir-start (default 0.5/0.5 prior) AND
# --prefix-pad-n 20. Tests whether the two fixes stack.
#
# Output:  ${RESULTS_DIR}/<sp>/annotate_${WEIGHTS_TAG}_ir_start_pad20/orfs.gtf
#
#SBATCH --job-name=annot_vt_ir_pad
...
#SBATCH --array=0-3
#SBATCH --output=/projects/AI-GUSTUS/tiberius_orf_finder/logs/annot_vt_ir_pad_%A_%a.out
#SBATCH --error=/projects/AI-GUSTUS/tiberius_orf_finder/logs/annot_vt_ir_pad_%A_%a.err
...
OUTDIR=${RESULTS_DIR}/${species}/annotate_${WEIGHTS_TAG}_ir_start_pad20
