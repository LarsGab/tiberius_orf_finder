...
#SBATCH --output=/projects/AI-GUSTUS/tiberius_orf_finder/logs/nf_reuse_bam_vert_%j.out
#SBATCH --error=/projects/AI-GUSTUS/tiberius_orf_finder/logs/nf_reuse_bam_vert_%j.err
